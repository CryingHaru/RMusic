...
mixin _$Artist {
 ...
 String get id; String? get name; String? get thumbnailUrl; int? get timestamp; int? get bookmarkedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,thumbnailUrl,timestamp,bookmarkedAt);

@override
String toString() {
  return 'Artist(id: $id, name: $name, thumbnailUrl: $thumbnailUrl, timestamp: $timestamp, bookmarkedAt: $bookmarkedAt)';
}
...
@useResult
$Res call({
 String id, String? name, String? thumbnailUrl, int? timestamp, int? bookmarkedAt
});
...
/// Create a copy of Artist
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = freezed,Object? thumbnailUrl = freezed,Object? timestamp = freezed,Object? bookmarkedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? name,  String? thumbnailUrl,  int? timestamp,  int? bookmarkedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Artist() when $default != null:
return $default(_that.id,_that.name,_that.thumbnailUrl,_that.timestamp,_that.bookmarkedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? name,  String? thumbnailUrl,  int? timestamp,  int? bookmarkedAt)  $default,) {final _that = this;
switch (_that) {
case _Artist():
return $default(_that.id,_that.name,_that.thumbnailUrl,_that.timestamp,_that.bookmarkedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String? name,  String? thumbnailUrl,  int? timestamp,  int? bookmarkedAt)?  $default,) {final _that = this;
switch (_that) {
case _Artist() when $default != null:
return $default(_that.id,_that.name,_that.thumbnailUrl,_that.timestamp,_that.bookmarkedAt);case _:
  return null;
...
class _Artist implements Artist {
  const _Artist({required this.id, this.name, this.thumbnailUrl, this.timestamp, this.bookmarkedAt});
...
/// Create a copy of Artist
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = freezed,Object? thumbnailUrl = freezed,Object? timestamp = freezed,Object? bookmarkedAt = freezed,}) {
