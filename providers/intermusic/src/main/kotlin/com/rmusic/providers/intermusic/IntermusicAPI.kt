...
class IntermusicAPI(
    ...
    var locale = IntermusicLocale(gl = Locale.getDefault().country.ifBlank { "US" }, hl = Locale.getDefault().toLanguageTag())
    ...
    private fun androidContext(): IntermusicContext = IntermusicContext(
    ...
    private fun iosContext(): IntermusicContext = IntermusicContext(
        client = IntermusicContext.Client(
            clientName = "IOS",
